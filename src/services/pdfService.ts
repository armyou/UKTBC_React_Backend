...
export async function generateDonationReceiptPDF(payment: any): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    try {
      ...
      // ===== Header with logo =====
      const logoPath = path.join(process.cwd(), 'src/resources/UKTBC Logo PNG.png');
      let headerY = 20;
      let logoHeight = 0;
